...
function Practice({ s = 22 }) {
  return (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none">
      <rect x="5" y="4.5" width="14" height="16.5" rx="2.5" stroke="currentColor" strokeWidth="2" />
      <path d="M9 3.5h6v3H9z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
      <path d="M8.5 13l2.2 2.2L15.5 10.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
